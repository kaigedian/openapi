...
| **字段**    | **类型**  | **必填**  | **举例**                 | **说明**   |
| ----------- | -------- | -------- | ------------------------ | ---------- |
| transNo     | String   | 是       | 1111                     | 商家请求流水号，请保证流水号唯一性，对于重复的流水号请求，将不会处理，请求流水号长度 <= 36 位 |
...
根据请求流水号、兑换码，作废兑换码，请求流水号和兑换码二选一。
...
| redeemCodes | Array    | 否       | ["249916165","45782212"] | 需要设置失效的兑换码数组，请求流水号和兑换码二选一。每次最多传100个兑换码。 |
