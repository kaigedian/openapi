...
* 请求url
	`/member/getMemberInfoByIdOrMobile`
...
| **字段**       | **类型** | 是否必传 | 举例                                                   | **说明**                                                     |
| -------------- | -------- | -------- | ------------------------------------------------------ | ------------------------------------------------------------ |
| partnerId      | String   | 是       | 商户号，农工商编号固定                                 |                                                              |
| channelCode    |String    |是        |渠道编码{xcx:会员小程序,dcxcx:点餐小程序,ptxcx:拼团小程序,wcxcx:围餐小程序,wsc:微商城,sqfx:社群分销}|                                                          |
| mobile         | String   | 是       | 手机号码                                               |                                                              |
| registerType   | String   | 是       | 注册类型{1门店，2、页面注册、3领卡、4扫码、5支付即会员 |                                                              |
| appId          | String   | 是       | 应用的ID                                               |                                                              |
| unionId        | String   | 是       | 微信unionId                                            | unionId、thirdPartyCode二选一必传；如果非微信和ThirdPartyCode一致 |
| thirdPartyCode | String   | 是       | 会员应用下的用户标识                                   |                                                              |
| nickName       | String   | 否       | 昵称                                                   |                                                              |
| sexFlag        | String   | 否       | 性别{0未知1男2女}                                      |                                                              |
